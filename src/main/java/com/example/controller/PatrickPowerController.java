...
public class PatrickPowerController extends GeneralBookieController {
    ...
    @RequestMapping(value = "/PatrickPower/Basketball", method = RequestMethod.GET)
    public String bookieGetBasketball(Model model) {
        return super.bookieGetBasketball(model, bookie);
    }

    @RequestMapping(value = "/PatrickPower/Basketball/{hrefInfo}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/PatrickPower/Basketball/placeBet", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/PatrickPower/Football", method = RequestMethod.GET)
    public String bookieGetFootball(Model model) {
        return super.bookieGetFootball(model, bookie);
    }

    @RequestMapping(value = "/PatrickPower/Football/{hrefInfo}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/PatrickPower/Football/placeBet", method = RequestMethod.POST)
